# TP3_PAA
-Para compilar navegue até o diretório do código é digite 'make' no terminal, será gerado o executável com o nome 'tp3'.

-Para executar basta digitar no terminal " ./tp3 'caminho_do_arquivo_de_entrada.txt' 'inteiro_do_algoritmo' ".

 inteiros referentes a cada algoritmo:
